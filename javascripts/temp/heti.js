...
(function (global, factory) {
  ...
  class Heti {
    ...
    spacingElement ($$elm) {
      ...
      const spacingStart = function (text) {
        const $$r = document.createElement("span");
        const $$s = document.createElement("span");
        $$s.className = "heti-spacing";
        $$s.textContent = " ";
        $$r.textContent = text.trim();
        $$r.appendChild($$s);
        return $$r
      };
      const spacingEnd = function (text) {
        const $$r = document.createElement("span");
        const $$s = document.createElement("span");
        $$s.className = "heti-spacing";
        $$s.textContent = " ";
      ...
      const spacingStartEnd = function (text) {
        const $$r = document.createElement("span");
        const $$s1 = document.createElement("span");
        $$s1.className = "heti-spacing";
        $$s1.textContent = " ";
        const $$s2 = document.createElement("span");
        $$s2.className = "heti-spacing";
        $$s2.textContent = " ";
        $$r.textContent = text.trim();
        $$r.appendChild($$s1);
        $$r.insertBefore($$s2, $$r.firstChild);
        $$r.className = "heti-skip"
        return $$r
      }
      ...
      findAndReplaceDOMText($$elm, Object.assign({}, commonConfig, {
        ...
        replace: portion => spacingStartEnd(portion.text),
      ...
      findAndReplaceDOMText($$elm, Object.assign({}, commonConfig, {
        ...
        replace: portion => spacingStart(portion.text),
      }));

      findAndReplaceDOMText($$elm, Object.assign({}, commonConfig, {
        find: this.REG_END,
        // replace: portion => getWrapper('heti-spacing', 'heti-spacing-end', portion.text),
        replace: portion => spacingEnd(portion.text),
        offset: this.offsetWidth,
      }));
